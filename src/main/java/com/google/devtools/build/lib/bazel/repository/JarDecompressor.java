...
public class JarDecompressor implements Decompressor {
   ...
   * UCBUILD file containing one entry: the .jar.</p>
   */
  @Override
  @Nullable
  public Path decompress(DecompressorDescriptor descriptor) throws RepositoryFunctionException {
    ...
    try {
      ...
      // external/some-name/repository/jar/UCBUILD defines the //jar target.
      Path buildFile = jarDirectory.getRelative("UCBUILD");
      FileSystemUtils.writeLinesAs(
          buildFile,
          Charset.forName("UTF-8"),
          "# DO NOT EDIT: automatically generated UCBUILD file for "
